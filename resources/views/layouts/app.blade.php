...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'Crystalline Dental') }}</title>
    ...
    {{-- Vite: compiles Tailwind v4 + app.js --}}
    ...
    <div class="flex flex-col flex-1 overflow-hidden min-w-0">
        ...
        @if(session('success'))
            <div id="flash" style="
                ...
                background:rgba(79,219,204,.12); border:1px solid rgba(79,219,204,.3); color:#4fdbcc;
        ...
        @if(session('error') || $errors->any())
            <div id="flash-err" style="
                position:fixed; top:70px; right:20px; z-index:50;
                padding:10px 16px; border-radius:10px; font-size:13px; font-weight:500;
                background:rgba(255,180,171,.08); border:1px solid rgba(147,0,10,.4); color:#ffb4ab;
                animation: fadeSlideUp .3s ease forwards;
            ">
